...
;{{INJECT_START:PKG}}
OutFile "../_dist/Install_voicemeeter-windows-volume_v1.7.0.0_x64.exe"
...
!define SETUP_VERSION 1.7.0.0
!define MUI_TEXT_WELCOME_INFO_TEXT "This will guide you through the installation of Voicemeeter Windows Volume v1.7.0.0.$\r$\n$\r$\nClick Next to continue."
Name "Voicemeeter Windows Volume"
BrandingText "Voicemeeter Windows Volume v1.7.0.0"
...
;{{INJECT_START:UNINSTALLER}}
    ...
    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}" "DisplayVersion" 1.7.0.0
