...
;{{INJECT_START:PKG}}
OutFile "../_dist/Install_voicemeeter-windows-volume_v1.8.0.1_x64.exe"
...
!define PRODUCT_VERSION "1.8.0.1"
!define SETUP_VERSION 1.8.0.1
!define MUI_TEXT_WELCOME_INFO_TEXT "This will guide you through the installation of Voicemeeter Windows Volume v1.8.0.1.$\r$\n$\r$\nClick Next to continue."
Name "Voicemeeter Windows Volume"
BrandingText "Voicemeeter Windows Volume v1.8.0.1"
...
;{{INJECT_START:UNINSTALLER}}
    ...
    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}" "DisplayVersion" 1.8.0.1
